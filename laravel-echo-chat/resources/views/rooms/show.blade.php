    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <h3>Usuários</h3>
                <ul class="list-group">
                    <li class="list-group-item" align="center" v-for="o in users">
                        <a href="#">[[ o.name ]]</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="panel panel-content">
                    ...
                    <div class="panel-footer">
                        <div class="input-group">
                            <input type="text" class="form-control input-md" placeholder="Digite sua mensagem" autofocus v-model="content" v-on:keyup.enter="sendMessage"/>
